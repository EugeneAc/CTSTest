...
namespace CTS_Analytics.Models.Mnemonic
{
	public class MnemonicMain
	{
		public MnemonicMain()
		{
			...
			COF = new COF();
            WeightDetails = new WeightsDetail[17];
            for (int i = 0; i < WeightDetails.Length; i++)
            {
                WeightDetails[i] = new WeightsDetail();
            }
        }
        ...
        public WeightsDetail[] WeightDetails { get; set; }

        public decimal TotalPlan { get { return Shah.ProdPlan + Tent.ProdPlan + Len.ProdPlan + Kaz.ProdPlan + Abay.ProdPlan + Sar1.ProdPlan + Sar3.ProdPlan + Kuz.ProdPlan + Kost.ProdPlan; } }
		public decimal TotalFact { get { return Shah.ProdFact + Tent.ProdFact + Len.ProdFact + Kaz.ProdFact + Abay.ProdFact + Sar1.ProdFact + Sar3.ProdFact + Kuz.ProdFact + Kost.ProdFact; } }
	}
    ...
    public class WeightsDetail
    {
        public WeightsDetail()
        {
            TooltipContent = @"#bi1";
        }
        ...
        public bool ConclusionFlag { get; set; }
        public float WeightIn1Train { get; set; }
        public float WeightPerPeriod { get; set; }
    }
}